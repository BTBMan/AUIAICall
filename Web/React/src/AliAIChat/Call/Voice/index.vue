...
export default defineComponent({
  ...
  setup() {
    ...
    const { agentState: storeAgentState, isSpeaking } = storeToRefs(useCallStore())
    ...
    const avatarUrl = computed(() => {
      return controller.value?.config.templateConfig?.avatarUrl
    })
